...
static_assert(interpretar("MODO AUTO").tipo == TipoComando::MODO_AUTO, "Modo auto");
static_assert(interpretar("MODO MANUAL").tipo == TipoComando::MODO_MANUAL, "Modo manual");
static_assert(interpretar("VOL+").tipo == TipoComando::VOL_MAS, "Vol mas");
static_assert(interpretar("VOL-").tipo == TipoComando::VOL_MENOS, "Vol menos");
static_assert(interpretar("MUTE ON").tipo == TipoComando::MUTE, "Mute");
static_assert(interpretar("VOZ OFF").tipo == TipoComando::VOZ, "Voz");
static_assert(interpretar("PAGINA 2").valor == 2, "Pagina");
static_assert(interpretar("IR LEER").tipo == TipoComando::IR_LEER, "IR leer");
